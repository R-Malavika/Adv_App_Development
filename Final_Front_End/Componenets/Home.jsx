...
const Home = () => {
  ...
  return (
    <div>
      ...
      <img src={homebg} alt="bg" style={{ width: '100%', height: '100%', objectFit: 'cover' }} /><p style={{ position: 'absolute', top: '50%', left: '23%', transform: 'translate(-50%, -50%)', color: 'white', fontSize: '55px',zIndex:'1' }}>
     ...
     <center><h1 className='homhead'>LOAN SCHEMES</h1></center><br/><br/>
      <div style={{ display: 'flex', justifyContent: 'space-between' }}>
        ...
        <Card sx={{ maxWidth: 345, marginLeft:'20px', marginRight: '10px', marginBottom: '20px',transition: 'transform 0.3s',
        '&:hover': {
          transform: 'scale(1.05)',boxShadow: '0 0 10px rgba(0, 255, 0, 0.5)',} }}>
        <CardMedia
          sx={{ height: 140 }}
      ...
      <Card sx={{ maxWidth: 345, marginRight: '10px', marginBottom: '20px',transition: 'transform 0.3s',
      '&:hover': {
        transform: 'scale(1.05)',boxShadow: '0 0 10px rgba(0, 255, 0, 0.5)',} }}>
        <CardMedia
          sx={{ height: 140 }}
