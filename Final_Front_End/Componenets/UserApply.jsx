...
const UserApply = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Increment tot, assuming it is meant to count the number of requests
      let tot = localStorage.getItem('totalreq') || 0;
      tot = parseInt(tot, 10) + 1;
      localStorage.setItem('totalreq', tot);
  ...
  return (
    <div>
      ...
      <input type="text" id="panCard" name="panNum" value={formData.panNum} onChange={handleChange} required />
    </div>
              ...
              <div className="form-row">
                <label htmlFor="amount">Document Type:</label>
                <input type="text" id="doctype" name="doctype" value={formData.doctype} onChange={handleChange} required />
              </div>
              <div className="form-row">
