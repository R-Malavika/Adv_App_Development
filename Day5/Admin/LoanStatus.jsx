      ...
      ,
    {
      ...
      render: (_, record) => (
        <Space>
          ...
          <Button type="danger" onClick={() => handleReject(record)} style={{backgroundColor:'crimson',color:'white'}}>
            Reject
          </Button>
        </Space>
      ),
    ...
    <div className="das">
      ...
      {selectedRowKeys.length > 0 && (
        <div style={{ marginTop: 16 }}>
          ...
          <Button type="danger" onClick={handleBulkReject} style={{ marginLeft: 8,backgroundColor:'crimson',color:'white'}}>
            Bulk Reject
          </Button>
        </div>
      )}
